	...
	protected function _connect()
	{
		...
		$streamContext = stream_context_create(
                   array(
                     'ssl' => array(
                               'local_cert' => $this->_sProviderCertificateFile,
                               'passphrase' => (!empty($this->_sProviderCertificatePassphrase) ? $this->_sProviderCertificatePassphrase : '')
                              )
                   )
);
